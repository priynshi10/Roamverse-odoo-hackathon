...
export const activityCatalog = [
  { title: "Hot air balloon ride", category: "adventure" as const, cost: 220 },
  { title: "Street food tour", category: "food" as const, cost: 45 },
  { title: "Museum entry", category: "culture" as const, cost: 25 },
  { title: "National park hike", category: "nature" as const, cost: 15 },
  { title: "Local market shopping", category: "shopping" as const, cost: 60 },
  { title: "Rooftop bar evening", category: "nightlife" as const, cost: 40 },
  { title: "City walking tour", category: "sightseeing" as const, cost: 30 },
  { title: "Sunset boat cruise", category: "adventure" as const, cost: 95 },
  { title: "Cooking class", category: "food" as const, cost: 70 },
  { title: "Temple visit", category: "culture" as const, cost: 10 },
  { title: "Snorkeling trip", category: "nature" as const, cost: 55 },
  { title: "Live music venue", category: "nightlife" as const, cost: 35 },
];
...
export const sampleTrips: Trip[] = [
  {
    ...
    cities: [
      {
        ...
        days: [
          ...
          { id: "d2", date: "2026-06-13", activities: [
            { id: "a3", title: "Caldera boat cruise", category: "adventure", cost: 95, time: "10:00" },
            { id: "a4", title: "Greek dinner in Fira", category: "food", cost: 60, time: "20:00" },
          ]},
        ],
      },
    ],
    ...
    budget: { transport: 1200, hotel: 1800, activities: 600, meals: 700, other: 200 },
  ...
  },
  {
    ...
    packing: [],
    notes: [],
    budget: { transport: 2400, hotel: 2200, activities: 900, meals: 1100, other: 300 },
    createdAt: new Date().toISOString(),
  },
];
